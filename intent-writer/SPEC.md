...
**Authority:** delegation-triage crosswalk **v0.2.1** (ratified v0.2 2026-07-24,
D-B3-1/D-B3-2; amended 2026-07-26 after this module's R1 conformance review) —
`delegation-triage:docs/proposals/2026-07-24-intent-outcome-record-crosswalk.md`. This file was
re-synced to v0.2.1 in the same pass as the fix commit; the seven amended areas are marked
**[v0.2.1]** below. This module
...
- `CODE_RE = ^[A-Za-z0-9][A-Za-z0-9._:+/@-]{0,127}$` for code-shaped strings. **CODE_RE alone
  ...
  projection. No vocabulary is registered yet, so `other` + free slot is the only honest form
  today; the registries are module constants, patchable the moment one is published.
